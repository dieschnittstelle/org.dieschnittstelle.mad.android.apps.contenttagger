...
// DragListener Interface Methods
    ...
    public void onDragStart(DragSource source, Object info, int dragAction) {
        ...
        View v = null;//findViewById (R.id.delete_zone_view);
//        if (v != null) {
...
//        }
    ...
    // we need to add an additional drop target for the dynamically created control elements
    public void addDropTarget(DropTarget element) {
        mDragController.addDropTarget(element);
    }

    @Override
    public void onDrop(View source, View target, boolean allowed) {
        if (this.onDropListener != null) {
            this.onDropListener.onDrop(source,target,allowed);
        }
    }
