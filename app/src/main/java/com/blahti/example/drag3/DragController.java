...
public class DragController {
    ...
    public void startDrag(Bitmap b, int screenX, int screenY,
        ...
        Log.i(TAG,"startDrag(): " + screenX + "," + screenY);
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        Log.d(TAG,"onInterceptTouchEvent(): dragging is: " + mDragging);
    ...
    private boolean drop(float x, float y) {
        ...
        if (dropTarget != null) {
            ...
            if (dropTarget.acceptDrop(mDragSource, coordinates[0], coordinates[1],
                    (int) mTouchOffsetX, (int) mTouchOffsetY, mDragView, mDragInfo)) {
                // we do not feedback the dropping to the cell itself, but leave drop handling up to the application
//                dropTarget.onDrop(mDragSource, coordinates[0], coordinates[1],
//                        (int) mTouchOffsetX, (int) mTouchOffsetY, mDragView, mDragInfo);
                mDragSource.onDropCompleted((View) dropTarget, true);

                mListener.onDrop((View)mDragSource,(View)dropTarget, true);
                return true;
            } else {
                mDragSource.onDropCompleted((View) dropTarget, false);
                mListener.onDrop((View)mDragSource,(View)dropTarget, false);
                return true;
            }
        }
        return false;
