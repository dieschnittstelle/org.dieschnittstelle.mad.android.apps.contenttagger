    ...
    implements DragSource, DropTarget
{
    ...
    public int onDragEnteredColor;
    public int onDragLeftColor;

    protected static String logger = "ImageCell";
...
public void onDragEnter(DragSource source, int x, int y, int xOffset, int yOffset,
        DragView dragView, Object dragInfo)
{
    Log.d(logger,"onDragEnter()");
//    int bg = mEmpty ? R.color.cell_empty_hover : R.color.cell_filled_hover;
    setBackgroundResource (onDragEnteredColor);
}
...
public void onDragExit(DragSource source, int x, int y, int xOffset, int yOffset,
        DragView dragView, Object dragInfo)
{
    Log.d(logger,"onDragExit()");
//    int bg = mEmpty ? R.color.cell_empty : R.color.cell_filled;
    setBackgroundResource (onDragLeftColor);
}
