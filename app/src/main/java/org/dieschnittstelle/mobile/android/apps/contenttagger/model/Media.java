...
//    private Bitmap image;
    ...
    public void setContentUri(String contentUri) {
        // if we reset the contentUri we need to reset the thumbnail
        if (this.contentUri != null && contentUri != null && !this.contentUri.equals(contentUri)) {
